...
export default function Home() {
  return (
    <Layout
      ...
      description="Technical Documentation For The Semaphore Protocol."
    >
      <Container>
        <DocsHeader>
          <div
          ...
          >
            ...
            >
              A privacy gadget for creating anonymous proof of membership on
              Ethereum.
            </p>
        ...
        >
          <div>
            ...
            <p>
              Learn more about the code of the various Semaphore components.
            </p>
