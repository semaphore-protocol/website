...
:::note
Make sure you have added the environment variables in the project root folder. The required ones are: the default network, the Infura API Key, the private key, the Semaphore contract address, the Feedback contract address and the group id.
::: 
